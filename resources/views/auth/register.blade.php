                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index" class="d-inline-block auth-logo">
                                    <img src="{{ URL::asset('build/images/logo-02.png') }}" alt="" height="20">
                                    <!-- <h1>Lawyer App</h1> -->
                                </a>
                            </div>
                                    ...
                                    <form class="needs-validation" novalidate method="POST"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-6 d-flex flex-column align-items-end">
                                                    <label for="arabName" class="form-label float-end"><span class='text-danger'>*</span> الاسم الكامل</label>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-6 d-flex flex-column align-items-end">
                                                    <label for="arabCity" class="form-label float-end"><span class='text-danger'>*</span>المدينة</label>
