...
<!-- custom Css-->
@if(app()->getLocale() === 'ae')
    <link href="{{ URL::asset('build/css/app.min.rtl.css') }}?v={{ time() }}" id="app-style-rtl" rel="stylesheet" type="text/css" />
    <link href="{{ URL::asset('build/css/bootstrap.min.rtl.css') }}?v={{ time() }}" id="bootstrap-style-rtl" rel="stylesheet" type="text/css" />
