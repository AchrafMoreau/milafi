...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function (raw) {
        console.log(raw.id)
        tasksList.add({
            id: '<td class="fw-medium link-primary">00' + raw.id + "</td>",
            case: '<a href="apps-projects-overview" class="fw-medium link-primary">' + raw.cas.title_file + "</a>",
            tasks_title: raw.title,
            task_desc: raw.description,
            dueDate: raw.dueDate,
...
//                     case: '<a href="apps-projects-overview" class="fw-medium link-primary">'+projectNameField.value+"</a>",
//                     tasks_title: tasksTitleField.value,
//                     task_desc: clientNameField.value,
//                     dueDate: fomateDate(dateDueField.value),
